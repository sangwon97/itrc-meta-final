...
export const tvItems = [
  { id: 'tv-booth', src: 'models/TVs/TV_New.glb' },
];
...
export const assetItems = [
  ...
  { id: 'carpet-gray', src: 'models/Carpet_Gray.glb' },
  { id: 'booths', src: 'models/WholeBooth.glb' },
  { id: 'special-booth', src: 'models/Special_Booth.glb' },
  { id: 'navmesh', src: 'models/NavMesh_WholeMap.glb' },
  { id: 'navmeshMovable', src: 'models/NavMesh_Movable.glb' },
  { id: 'panel-special-1', src: 'models/Panels/Panel_Special1.glb' },
  { id: 'panel-special-2', src: 'models/Panels/Panel_Special2.glb' },
